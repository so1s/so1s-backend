...
INSERT INTO DEPLOYMENT (CREATED_ON, UPDATED_ON, NAME, STATUS, DEPLOYMENT_STRATEGY_ID, MODEL_METADATA_ID, RESOURCE_ID) VALUES (now(), now(), 'tensorflowModel2Deploy', 'pending', 1, 2, 1);
