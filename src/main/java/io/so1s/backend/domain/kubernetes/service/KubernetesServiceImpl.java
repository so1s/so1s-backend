...
public class KubernetesServiceImpl implements KubernetesService {
    ...
    public boolean deployInferenceServer(
        ...
        istioClient.v1beta1().virtualServices().inNamespace(namespace).createOrReplace(inferenceVirtualService);
    ...
    public boolean deployABTest(ABTest abTest) {
        ...
        istioClient.v1beta1().virtualServices().inNamespace(namespace).createOrReplace(abTestVirtualService);
