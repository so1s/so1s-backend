...
import io.so1s.backend.global.utils.ObjectMapperFactory;
...
public class JacksonConfig {
  ...
  public ObjectMapper camelObjectMapper() {
    return ObjectMapperFactory.create(camelNamingStrategy());
  }

  @Bean
  @Qualifier("snakeObjectMapper")
  public ObjectMapper snakeObjectMapper() {
    return ObjectMapperFactory.create(snakeNamingStrategy());
  }
