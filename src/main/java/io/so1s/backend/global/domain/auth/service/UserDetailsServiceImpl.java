package io.so1s.backend.global.domain.auth.service;

import io.so1s.backend.global.domain.auth.repository.UserRepository;
...
public class UserDetailsServiceImpl implements UserDetailsService {
  ...
  private org.springframework.security.core.userdetails.User getUser(
      io.so1s.backend.global.domain.auth.entity.User user) {
